"""``/api/v1/leads/*`` — CRM core.

Carved from ``app.py`` Wave 9. Covers the full lead lifecycle:
list, export (CSV + XLSX), bulk-update, update, delete, re-enrich,
custom-fields, activities, draft-email, bulk-draft, and mark.

Saved-searches routes live in ``routes/saved_searches.py``.
Task routes live in ``routes/tasks.py``.
"""
