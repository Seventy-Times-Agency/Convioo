...
export const uk = {
  ...
  "connectors.subtitle": "Підключіть CRM, пошту та інструменти даних.",
  ...
  "connectors.cat.crm": "CRM",
  "connectors.cat.export": "Експорт і синхронізація",
  ...
  "lead.extras.activity.repliedKind": "Відповідь: {summary}",
  "lead.extras.activity.repliedKindBare": "Відповів на лист",
  "lead.extras.activity.suggestedReply": "Пропонована відповідь:",
  "lead.extras.activity.replyCategory.interested": "Зацікавлений",
  "lead.extras.activity.replyCategory.meeting_request": "Зустріч",
  "lead.extras.activity.replyCategory.question": "Питання",
  "lead.extras.activity.replyCategory.objection": "Заперечення",
  "lead.extras.activity.replyCategory.not_interested": "Не цікаво",
  "lead.extras.activity.replyCategory.unsubscribe": "Відписка",
  "lead.extras.activity.replyCategory.auto_reply": "Автовідповідь",
  "lead.extras.activity.replyCategory.referral": "Перенаправлення",
  "lead.extras.activity.replyCategory.other": "Відповідь",
  ...
  "search.form.title": "Кого шукаємо?",
  "search.form.subtitle": "Опишіть нішу та регіон — система збере й оцінить базу.",
  ...
  "crm.bulk.assignTo": "Розподілити",
  "crm.bulk.assignNoRep": "Селз: не змінювати",
  "crm.bulk.assignFunnel": "Воронка…",
  "crm.bulk.assignButton": "Призначити {n}",
  "crm.bulk.assigned": "Призначено лідів: {n}",
  "crm.lang.all": "Мова: всі",
  "crm.lang.hint":
    "Мова бізнесу визначається під час збагачення: сайт, відгуки, імена, соцмережі",
  "cost.estimate": "Оцінка: ~{n} лідів · ~${x} з повним досьє",
  ...
  "cost.capLabel": "Місячна стеля, $",
  "cost.capHint": "80% — попередження в Telegram, 100% — стоп. Порожньо = без стелі.",
  "cost.capSaved": "Стелю збережено",
  "cost.capInvalid": "Стеля має бути додатним числом",
  "cost.ownerOnly": "Стелю задає власник команди.",
  "email.spamWarn":
    "Спам-скор листа {score}/10 ({issues}). Надіслати як є?",
  "auth.demo.title": "Демо-версія — без реєстрації",
  "auth.demo.subtitle":
    "Готова команда, воронка, ліди та муляж парсера. Обери роль і тестуй усі кнопки.",
  "auth.demo.owner": "Увійти власником",
  "auth.demo.manager": "Менеджер",
  "auth.demo.sales": "Селз",
  "auth.demo.admin": "Адмін",
  "work.emptyTitle": "Черга порожня",
  "work.emptyHint":
    "Тут іде продзвін: передзвони → гарячі → решта. Ліди з'являться, коли менеджер розподілить пакет у вашу воронку.",
  "work.noTeamHint":
  ...
  "work.tabAnalysis": "Повний аналіз",
  "work.tabReviews": "Відгуки",
  "work.tabSite": "Сайт і соцмережі",
  ...
  "work.cntDials": "Набори",
  "work.cntTalks": "Розмови",
  "work.cntGoals": "Цілі",
  "work.factReviews": "Відгуки",
  "work.factSite": "Сайт",
  "work.factSocial": "Соцмережі",
  "work.factLang": "Мова",
  "work.scriptEmpty": "Менеджер ще не завантажив скрипт",
  "work.objectionsTitle": "Заперечення",
  "common.yes": "є",
  "common.no": "немає",
  "work.notePh": "що сказав, про що домовилися…",
  "work.callButton": "Подзвонити",
  "work.recNote": "Клік набирає номер (tel:). Запис дзвінків — етапом телефонії.",
  "work.finishCall": "Завершити розмову",
  "work.duringHint": "Йде розмова — результати стануть активні після завершення.",
  "work.oNoAnswer": "Недодзвін",
  "work.oWrongNumber": "Невірний номер",
  "work.oRefused": "Відмова",
  "work.oThinking": "Думає",
  "work.oCallback": "Передзвонити…",
  "work.oGoalFallback": "Ціль досягнуто",
  "work.cbWhen": "Коли передзвонити:",
  "work.cb2h": "через 2 години",
  "work.cbTomorrow": "завтра",
  "work.cb3d": "через 3 дні",
  "work.goalToast": "Ціль досягнуто: {goal}",
  "work.footnote":
    "Цільову дію задає воронка ліда · недодзвін ×{n} → пауза {d} днів → у вільні",
  ...
  "crm.table.company": "Компанія",
  "crm.table.niche": "Ніша",
  "crm.table.geo": "Гео",
  "crm.table.lang": "Мова",
  "crm.table.assignee": "Призначено",
  "crm.table.free": "вільний",
  "crm.counts.total": "Усього",
  "crm.counts.free": "вільних",
  "crm.counts.inWork": "у роботі",
  "crm.counts.archived": "архів",
  ...
  "settings.notion.syncButton": "Синхронізувати з Notion",
  "settings.notion.syncHint": "Перенести зміни статусів із Notion назад у Convioo.",
  "settings.notion.syncResult": "Синхронізація завершена: {updated} оновлено, {errors} помилок.",
  "settings.notion.syncFailed": "Помилка синхронізації: {detail}",
  ...
  "team.member.confirmRemove": "Видалити цього учасника з команди? Якщо за ним закріплені ліди, спершу попросимо передати їх.",
  "team.member.transferPrompt": "За учасником закріплені ліди. Передати їх:",
  "team.member.transferPick": "Оберіть учасника…",
  "team.member.transferAndRemove": "Передати й видалити",
  ...
  "team.calls.funnel": "Воронка відділу · {days} днів",
  "team.calls.dials": "Набори",
  "team.calls.connects": "Додзвони",
  "team.calls.goals": "Цілі",
  "team.calls.goalRate": "{p}% від додзвонів",
  "team.calls.byDay": "Набори по днях",
  "team.calls.byRep": "По селзах · {days} днів",
  "team.calls.rep": "Селз",
  "team.calls.conversion": "Конверсія",
  ...
  "search.form.leadCountHint": "Один лід — один токен; менше лідів — швидший результат",
  "search.form.leadCountHelp": "Один базовий лід коштує один токен. Де саме шукати, можна обрати в розширеному пошуку.",
  "search.form.sources": "Джерела даних",
  "search.form.sourcesHint": "Зніміть позначку, якщо джерело сьогодні вередує",
  "search.form.advancedShow": "Розширений пошук",
  "search.form.advancedHide": "Згорнути розширений пошук",
  "search.form.channels": "Де шукати",
  "search.form.channelsHint": "Канали пошуку — можна лишити всі",
  "search.form.dm": "Контакт керівника",
  "search.form.dmHint": "Дорожче, знаходиться не завжди",
  "search.form.dmHelp": "Шукати імʼя та контакт того, хто ухвалює рішення. Це додаткові запити до платних джерел, і для частини компаній контакт не знаходиться взагалі. Вимкніть, якщо потрібен лише список компаній.",
  ...
  "developers.webhooks.replayTitle": "Захист від повторів (підпис із міткою часу)",
  "developers.webhooks.replayBody": "Кожна доставка також несе підпис із міткою часу. Старий заголовок вище лишається без змін для зворотної сумісності, але радимо перевіряти саме цей підпис: він дозволяє відхиляти повторно надіслані доставки. Обчисліть HMAC-SHA256(secret, \"<timestamp>.<raw_body>\"), порівняйте за сталий час зі значенням v1 і відхиліть запит, якщо мітка часу відрізняється від вашого годинника більш ніж на 5 хвилин.",
  ...
  "lp.nav.features": "Можливості",
  "lp.nav.integrations": "Інтеграції",
  "lp.nav.developers": "Розробникам",
  "lp.hero.badge": "тепер сам сортує відповіді",
  "lp.hero.title1": "Опишіть.",
  "lp.hero.title2": "Готово.",
  "lp.hero.subtitle": "Одна фраза звичайною мовою перетворюється на оцінений, збагачений і готовий до розсилки список. Чотири джерела, один ШІ-аналітик, близько 90 секунд.",
  "lp.hero.prompt": "покрівельні компанії в Нью-Йорку",
  "lp.hero.find": "Знайти ліди",
  "lp.hero.startFree": "Почати безкоштовно",
  "lp.hero.watch": "Дивитися демо",
  "lp.hero.noCard": "Без картки",
  "lp.hero.sources": "Джерела:",
  "lp.hero.orb": "оцінює ваші ліди в реальному часі",
  "lp.metric.leads": "лідів збагачено",
  "lp.metric.rating": "середня оцінка",
  "lp.metric.integrations": "нативних інтеграцій",
  "lp.how.eyebrow": "Як це працює",
  "lp.how.title": "Фраза на вході — воронка на виході",
  "lp.step.describe.t": "Опишіть",
  "lp.step.describe.d": "Напишіть звичайною мовою, хто потрібен — ніша, регіон, будь-які умови.",
  "lp.step.collect.t": "Зберемо",
  "lp.step.collect.d": "Google Places, Yelp, OpenStreetMap і Foursquare — без дублів, сайти проскановані на контакти й сигнали.",
  ...
  "lp.feat.search.d": "Один запит, чотири джерела — без дублів, потім збагачення контактами із сайту кожної компанії.",
  "lp.feat.henry.t": "ШІ-копілот Генрі",
  "lp.feat.henry.d": "Оцінює кожного ліда, пояснює чому, пише листи й відповідає на питання про воронку.",
  ...
  "lp.henry.title": "Аналітик у команді, а не чат-бот у кутку",
  "lp.henry.body": "Генрі читає сайт кожного ліда, відгуки й сигнали, потім оцінює під вашу послугу. Просіть ліди, чернетки або зріз по воронці — він відповідає готовою роботою.",
  "lp.henry.p1": "Персональна оцінка під вашу послугу, а не загальна відмітка",
  "lp.henry.p2": "Пише вступи у вашому тоні — можна одразу надіслати або відредагувати",
  "lp.henry.p3": "Класифікує відповіді: цікаво / пізніше / не підходить — із готовими варіантами",
  "lp.henry.chatUser": "Знайди 20 стоматологів в Остіні зі слабкими сайтами й склади вступний лист",
  "lp.henry.chatBot": "Готово — 20 стоматологів знайдено. У 7 слабкі сайти (немає SSL, провалюють мобільний тест або не оновлювались 5+ років). Чернетки додано:",
  "lp.henry.lead1": "Немає SSL · сайт оновлено у 2019",
  "lp.henry.lead2": "Провалює тест швидкості на мобільних",
  "lp.henry.lead3": "Немає форми онлайн-запису",
  "lp.henry.draft": "Чернетка",
  "lp.int.eyebrow": "Інтеграції",
  "lp.int.title": "Вбудовується у ваш стек",
  "lp.int.body": "Нативні конектори плюс публічний API та вебхуки для всього іншого.",
  "lp.int.connect": "Підключити",
  "lp.int.g.email": "Пошта",
  "lp.int.g.crm": "CRM",
  "lp.int.g.workspace": "Простір",
  "lp.int.g.alerts": "Сповіщення",
  "lp.int.g.automation": "Автоматизація",
  "lp.pricing.eyebrow": "Тарифи",
  "lp.pricing.title": "Почніть безкоштовно, зростайте за потреби",
  "lp.pricing.monthly": "Помісячно",
  "lp.pricing.annual": "Рік −20%",
  "lp.pricing.popular": "Популярний",
  "lp.pricing.perMonth": "міс",
  "lp.tier.starter.name": "Starter",
  "lp.tier.starter.for": "Для фрилансерів",
  "lp.tier.starter.cta": "Почати безкоштовно",
  "lp.tier.starter.f1": "300 лідів / місяць",
  "lp.tier.starter.f2": "1 місце",
  "lp.tier.starter.f3": "ШІ-оцінка від Генрі",
  "lp.tier.starter.f4": "Експорт CSV та Excel",
  "lp.tier.starter.f5": "Підтримка поштою",
  "lp.tier.growth.name": "Growth",
  "lp.tier.growth.for": "Для невеликих агенцій",
  "lp.tier.growth.cta": "Почати пробний період",
  "lp.tier.growth.f1": "2 000 лідів / місяць",
  "lp.tier.growth.f2": "5 місць",
  "lp.tier.growth.f3": "Послідовності + ШІ-відповіді",
  "lp.tier.growth.f4": "Усі інтеграції",
  "lp.tier.growth.f5": "Пріоритетна підтримка",
  "lp.tier.agency.name": "Agency",
  "lp.tier.agency.for": "Для команд на масштабі",
  "lp.tier.agency.cta": "Зв'язатися з продажами",
  "lp.tier.agency.f1": "10 000 лідів / місяць",
  "lp.tier.agency.f2": "Безліміт місць",
  "lp.tier.agency.f3": "API та вебхуки",
  "lp.tier.agency.f4": "White-label звіти",
  "lp.tier.agency.f5": "Персональний менеджер",
  "lp.quote1": "Convioo замінив нам три інструменти. У понеділок вранці пишу фразу — до обіду воронка повна.",
  "lp.quote2": "Оцінка Генрі лячно точна. Наш відсоток відповідей подвоївся, бо ми пишемо лише тим, хто того вартий.",
  "lp.quote3": "Усю команду завели за один день. Відчуття завершеного продукту — рідкість у цій категорії.",
  "lp.trust.gdpr.t": "Відповідність GDPR",
  "lp.trust.gdpr.d": "Угоди про обробку даних і зберігання в ЄС за запитом.",
  "lp.trust.unsub.t": "Відписка в один клік",
  "lp.trust.unsub.d": "У кожній послідовності вбудована коректна обробка відписок.",
  "lp.trust.own.t": "Дані ваші",
  "lp.trust.own.d": "Експортуйте або видаляйте все — ліди, нотатки, стрічки — будь-коли.",
  "lp.trust.region.t": "ЄС · UK · US",
  "lp.trust.region.d": "Зроблено для агенцій по обидва боки Атлантики.",
  "lp.faq.eyebrow": "FAQ",
  "lp.faq.title": "Часті запитання",
  "lp.faq.sources.q": "Звідки беруться ліди?",
  "lp.faq.sources.a": "Із Google Places, OpenStreetMap, Yelp і Foursquare. Ми прибираємо дублі й збагачуємо контактами із сайтів компаній.",
  "lp.faq.how.q": "Наскільки точна оцінка Генрі?",
  "lp.faq.how.a": "Генрі оцінює кожного ліда під вашу послугу й пояснює причину, тож ви контактуєте лише з відповідними.",
  "lp.faq.credits.q": "Як рахуються ліди?",
  "lp.faq.credits.a": "Кожен тариф містить місячний ліміт лідів. Невикористані не переносяться; ліміт можна підвищити будь-коли.",
  "lp.faq.cancel.q": "Чи можна скасувати будь-коли?",
  "lp.faq.cancel.a": "Так. Жодних контрактів — керуйте підпискою з налаштувань, скасування в один клік.",
  "lp.cta.title1": "Перетворіть фразу",
  "lp.cta.title2": "на воронку продажів.",
  "lp.cta.sub": "Без картки · 50 безкоштовних лідів · Скасування будь-коли",
  "lp.foot.product": "Продукт",
  "lp.foot.company": "Компанія",
  "lp.foot.legal": "Правове",
  "lp.foot.about": "Про нас",
  "lp.foot.contact": "Контакти",
  "lp.foot.apidocs": "Документація API",
  "lp.foot.status": "Статус",
  "lp.foot.privacy": "Конфіденційність",
  "lp.foot.terms": "Умови",
  "lp.foot.cookies": "Cookies",
  "lp.foot.tagline": "ШІ-платформа лідогенерації для маркетингових агенцій.",
  "lp.foot.rights": "Усі права захищено.",

  // Воронки (хвиля 1)
  "funnels.validation": "Заповніть ім'я воронки та цільову дію",
  "funnels.confirmDelete":
    "Видалити воронку? Ліди залишаться в базі, але відв'яжуться від шляху торкань.",
  "funnels.noTeamTitle": "Воронки живуть у команді",
  "funnels.noTeamHint":
    "Перемкніться в командний простір, щоб налаштувати воронки відділу.",
  "funnels.listTitle": "Воронки команди",
  "funnels.emptyTeaches":
    "Воронка задає шлях торкань, скрипт, шаблони та зелену кнопку селза. Створіть першу — продукт стартує порожнім.",
  "funnels.cardMeta": "{n} лідів · ціль: {goal}",
  "funnels.new": "Нова воронка",
  "funnels.footnote":
    "Воронка задає шлях торкань, скрипт, шаблони та зелену кнопку селза",
  "funnels.pickTitle": "Оберіть воронку",
  "funnels.pickHint":
    "Ліворуч — воронки команди. Оберіть одну для налаштування або створіть нову.",
  "funnels.newTitle": "Нова воронка",
  "funnels.duplicate": "Дублювати",
  "funnels.goalSection": "Цільова дія — зелена кнопка селза",
  "funnels.name": "Ім'я воронки",
  "funnels.status": "Статус",
  "funnels.statusDraft": "чернетка",
  "funnels.statusActive": "активна",
  "funnels.statusArchived": "архів",
  "funnels.goalName": "Назва цілі — будь-яка, ваша",
  "funnels.goalNameHint": "Вільний текст: аудит, демо, зустріч, продаж…",
  "funnels.goalPh": "Платний аудит",
  "funnels.goalPrice": "Ціна (необов'язково)",
  "funnels.goalAction": "При досягненні цілі",
  "funnels.actionPaymentCalendar": "Оплата + календар",
  "funnels.actionInvoice": "Рахунок",
  "funnels.actionBooking": "Бронь",
  "funnels.actionNone": "Нічого",
  "funnels.pathSection": "Шлях торкань",
  "funnels.noAnswerRule": "недодзвін ×{n} → пауза {d} днів → у вільні",
  "funnels.stepCall": "Дзвінок",
  "funnels.stepEmail": "Лист",
  "funnels.days": "дн.",
  "funnels.stepAuto": "авто",
  "funnels.stepNotePh": "нотатка: скрипт, шаблон…",
  "funnels.addStep": "Додати торкання",
  "funnels.attempts": "Спроб додзвону",
  "funnels.pauseDays": "Пауза після недодзвонів, днів",
  ...
  "inbox.cat.all": "Усі",
  "inbox.cat.interested": "Цікаво",
  "inbox.cat.meeting": "Зустріч",
  "inbox.cat.question": "Питання",
  "inbox.cat.objection": "Заперечення",
  "inbox.cat.notInterested": "Не цікаво",
  "inbox.cat.unsubscribe": "Відписка",
  "inbox.cat.autoReply": "Автовідповідь",
  "inbox.cat.referral": "Переадресація",
  "inbox.cat.other": "Інше",
  "inbox.aiHint": "розбір вхідних — автоматично, ШІ",
  "inbox.draftReady": "чернетка готова",
  "inbox.aiVerdict": "Розбір ШІ",
  "inbox.draftTitle": "Чернетка відповіді · від ШІ",
  "inbox.copyDraft": "Скопіювати чернетку",
  "inbox.sendHint": "Надсилання зʼявиться, коли буде підключено поштову скриньку.",
  "inbox.noDraft": "Для цієї категорії чернетка не готується.",
  "letters.tabCalls": "Продзвін",
  "letters.tabLetters": "Листи",
  "letters.quota": "Ліміт надсилання сьогодні: {sent} / {cap} · прогрів домену, день {day}",
  "letters.pending": "Чекають схвалення · {n}",
  "letters.scheduled": "Підуть автоматом · {n}",
  "letters.touch": "дотик {i} з {n}",
  "letters.pendingEmpty": "Нічого не чекає схвалення.",
  "letters.scheduledEmpty": "На сьогодні автоматичних листів немає.",
  "letters.suppressionNote": "Відписки та «не писати» дотримуються автоматично.",
  "letters.workerNote": "Автоматичні листи надсилає фоновий воркер — без нього черга стоїть.",
  "st.tab.company": "Компанія",
  "st.tab.integrations": "Інтеграції",
  "st.tab.telephony": "Телефонія",
  "st.tab.mail": "Пошта",
  ...
  "intg.st.notConnected": "не підключено",
  "intg.st.soon": "скоро",
  "intg.configure": "Налаштувати",
  "intg.connect": "Підключити",
  "intg.unavailable": "Недоступно",
  "intg.telegram.title": "Telegram-бот",
  ...
  "intg.calendar.desc": "Слоти аудитів і зустрічей. Посилання на бронь іде клієнту при досягненні цілі воронки.",
  "intg.hubspot.title": "HubSpot",
  "intg.hubspot.desc": "Вивантаження угод у вашу CRM. Push працює, зворотна синхронізація — у планах.",
  "intg.pipedrive.title": "Pipedrive",
  "intg.pipedrive.desc": "Вивантаження угод у Pipedrive.",
  "intg.notion.title": "Notion",
  "intg.notion.desc": "Двостороння синхронізація бази лідів із Notion.",
  "intg.slack.title": "Slack",
  "intg.slack.desc": "Сповіщення про нових лідів і відповіді у ваш канал.",
  "intg.sheets.title": "Google Sheets",
  "intg.sheets.desc": "Вивантаження результатів видобутку просто в таблицю.",
  "intg.agencyos.title": "Agency OS",
  "intg.agencyos.desc": "Зв'язка з платформою доставки: ціль воронки → картка клієнта у виробництві.",
  "intg.webhooks.title": "Webhooks та API",
  "intg.webhooks.desc": "Власні автоматизації: події лідів ідуть на ваш URL з підписом.",
  "intg.marketplaceBtn": "Маркетплейс конекторів",
  "intg.footer": "Ключі інтеграцій зберігаються зашифровано, доступ — лише адмін і власник. Білінг і тарифи — розділ власника.",
  "tel.soonTitle": "Телефонія з'явиться тут",
  "tel.soonBody": "Підключення номерів, запис дзвінків із розшифровкою та правила запису за регіонами. Поки дзвінки йдуть через click-to-call з вашого телефону, а результати фіксуються в режимі «Робота».",
  "jr.immutable": "Журнал незмінний: записи не можна редагувати чи видаляти — навіть власнику",
  "jr.who": "Хто",
  "jr.kindF": "Тип",
  "jr.period": "Період",
  "jr.all": "усі",
  ...
  "jr.col.who": "ХТО",
  "jr.col.action": "ДІЯ",
  "jr.col.object": "ОБ'ЄКТ",
  "jr.system": "Система",
  "jr.today": "сьогодні",
  "jr.yesterday": "вчора",
  "jr.empty": "За вибраний період записів немає.",
  "jr.noTeam": "Журнал ведеться в командному просторі.",
  "jr.denied": "Журнал доступний власнику та адміністратору.",
  "jr.k.batch_assigned": "Розподіл пакета: {count} лідів → {assignee}",
  "jr.k.batch_assigned_pool": "Розподіл пакета: {count} лідів у воронку",
  "jr.o.batch": "База · воронка {funnel}",
  "jr.k.funnel_created": "Нова воронка: «{name}»",
  "jr.k.funnel_updated": "Зміна воронки: «{name}»",
  "jr.k.funnel_deleted": "Видалення воронки: «{name}»",
  "jr.o.funnels": "Воронки",
  "jr.k.member_invited": "Запрошення в команду: {role} (очікує прийняття)",
  "jr.o.team": "Команда",
  "jr.k.role_changed": "Зміна ролі: {member} — {from} → {to}",
  "jr.k.member_removed": "Видалення з команди: {member}",
  "jr.k.member_left": "Вихід із команди: {member}",
  "jr.k.transferredLeads": "{count} лідів передано",
  "jr.k.ownership_transferred": "Передача володіння: {to}",
  "jr.k.cost_cap_changed": "Зміна стелі витрат: {from} → {to}",
  "jr.o.settings": "Налаштування",
  "jr.k.search_finished": "Видобуток завершено: {leads} лідів · {tokens} токенів",
  "jr.o.search": "Видобуток · {region}",
  "jr.k.leads_exported": "Експорт бази (CSV)",
  "jr.o.base": "База",
  "jr.noCap": "без стелі",
  "bl.offNotice": "Внутрішній інстанс: білінг вимкнено. Екран — режим SaaS, вмикається налаштуванням при виході на ринок.",
  "bl.ownerOnly": "Білінг і тарифи — розділ власника.",
  "bl.perMonth": "/міс",
  "bl.current": "поточний",
  "bl.plan.solo.desc": "1 користувач · 500 токенів на місяць · 1 воронка · продзвін і листи",
  "bl.plan.team.desc": "до 8 людей · 3 000 токенів на місяць · воронки без ліміту · держреєстри",
  "bl.plan.agency.desc": "до 25 людей · 12 000 токенів на місяць · white-label звіти · API · пріоритетна підтримка",
  "bl.tokenHint": "1 базовий лід = 1 токен · пошук ОПР дорожче · докупівля токенів доступна на будь-якому тарифі",
  "bl.invoices": "РАХУНКИ",
  "bl.invoicesEmpty": "Рахунків поки немає — білінг не ввімкнено.",
  "bl.usage": "ВИКОРИСТАННЯ · 30 ДНІВ",
  "bl.tokens": "Токени",
  "bl.balance": "на балансі",
  "bl.spentMonth": "витрачено за 30 днів: {n}",
  "bl.leads": "Ліди з повним досьє",
  "bl.leadsHint": "один лід — один токен",
  "bl.emails": "Листи",
  "bl.emailsHint": "прогрів піднімає ліміт сам",
  "bl.spend": "Витрати видобутку",
  "bl.spendHint": "стелю задає власник у вкладці «Інтеграції»",
  "bl.topup": "Докупити токени",
  "bl.changePlan": "Змінити план",
  "bl.soon": "скоро",
  "bl.noTeam": "Тарифи й токени живуть у командному просторі.",
  "hp.heading": "Чим допомогти?",
  "hp.searchPh": "Пошук базою знань: «як поставити передзвін», «що означає скоринг»…",
  "hp.cat1.t": "Початок роботи",
  "hp.cat1.b": "Перший день у системі: черга, картка, результати — за 10 хвилин",
  "hp.cat2.t": "Продзвін",
  "hp.cat2.b": "Передзвони, запис, результати й що відбувається після кожної кнопки",
  "hp.cat3.t": "Листи та вхідні",
  "hp.cat3.b": "Чернетки від ШІ, ліміти надсилання, розбір відповідей",
  "hp.faq": "ЧАСТІ ЗАПИТАННЯ",
  "hp.q1": "Чому лід зник із моєї черги?",
  "hp.a1": "Спрацювало правило воронки «немає відповіді»: після кількох безуспішних спроб лід іде у вільний пул, щоб черга не забивалась. Менеджер може повернути його вам із Бази.",
  "hp.q2": "Що означає «гарячий» і звідки береться скоринг?",
  "hp.a2": "Скоринг 0–100 рахує ШІ за досьє компанії: сайт, відгуки, ознаки зростання. «Гарячий» — зацікавлена відповідь або високий бал. Це підказка пріоритету, а не вирок.",
  "hp.q3": "Як перенести передзвін на інший час?",
  "hp.a3": "У картці ліда виберіть результат «Передзвонити» і час. Лід повернеться в чергу рівно на призначену годину й підніметься нагору.",
  "hp.q4": "Клієнт просить не дзвонити — що натиснути?",
  "hp.a4": "Результат «Не турбувати». Номер і пошта потрапляють до списку виключень: система більше не подзвонить і не напише, навіть з іншої воронки.",
  "hp.ai.t": "Не знайшли відповіді — запитайте ШІ-асистента",
  "hp.ai.b": "Знає базу знань команди й підкаже щодо будь-якого екрана",
  "hp.ai.btn": "Запитати ШІ",
  "hp.soon": "скоро",
  "hp.noResults": "За запитом нічого не знайшлося. Запитайте тімліда — або напишіть нам.",
  "search.form.henryBtn": "Підібрати з Henry",
  ...
  "dob.history": "ІСТОРІЯ ЗАПУСКІВ",
  "dob.allSessions": "усі сесії ▸",
  "dob.historyEmpty": "Запусків ще не було. Перший пошук з'явиться тут.",
  "dob.failed": "помилка",
  ...
  "squads.title": "КОМАНДИ КОМПАНІЇ",
  "squads.hint": "Тімлід бачить свою команду й вільний пул; зведення — у керівника та власника",
  "squads.empty": "Команд поки немає — вся компанія працює спільним пулом. Створіть команду, призначте тімліда й роздайте людей.",
  "squads.membersCount": "{n} осіб",
  "squads.noLead": "без тімліда",
  "squads.leadPrefix": "тімлід:",
  "squads.toPool": "У спільний пул",
  "squads.addMember": "+ додати учасника",
  "squads.namePh": "Назва команди",
  "squads.create": "Створити команду",
  "squads.created": "Команду створено",
  "squads.deleteConfirm": "Розпустити команду «{name}»? Люди підуть у спільний пул, ліди залишаться за ними.",
  "jr.k.squad_created": "Нова команда: «{name}»",
  "jr.k.squad_updated": "Зміна команди: «{name}»",
  "jr.k.squad_deleted": "Команду розпущено: «{name}»",
  "jr.k.squad_member_moved": "Переведення до команди: {member} → {squad}",
  ...
  "work.emptyHintManager": "Черга показує лідів, призначених особисто на вас. Роздайте пакет команді в CRM — і черги селзів оживуть.",
  "work.emptyOpenCrm": "Відкрити CRM",
  "desk.myCalls": "Мій продзвін",
  "desk.backToDesk": "Пульт відділу",
  "desk.dials": "НАБОРИ",
  "desk.talks": "РОЗМОВИ",
  "desk.goals": "ЦІЛІ",
  "desk.col.rep": "СПІВРОБІТНИК",
  "desk.col.squad": "КОМАНДА",
  "desk.col.dials": "НАБОРИ",
  "desk.col.talks": "РОЗМОВИ",
  "desk.col.goals": "ЦІЛІ",
  "desk.col.overdue": "ПРОСТРОЧКА",
  "desk.col.state": "СТАН",
  "desk.live": "у роботі",
  "desk.idle": "сьогодні не дзвонив",
  "desk.quietSince": "тихо з {time}",
  "desk.overdueN": "{n} передзв.",
  "desk.emptyTitle": "Продзвін ще не починався",
  "desk.emptyHint": "Тут буде жива картина по кожному співробітнику: набори, розмови, цілі й прострочені передзвони. Роздайте лідів — і пульт оживе.",
  "desk.footnote": "Оновлюється само раз на хвилину. «У роботі» — дзвінок за останні 30 хвилин. Прострочка — передзвони, чий час уже минув.",
  "nav.rawBase": "База",
  "base.title": "База",
  "base.hint": "Сировина після видобутку: ще нікому не роздано й не торкнуто. Виберіть пачку й роздайте — картки поїдуть у CRM і черги селзів.",
  "base.subtitle": "сировина до першого торкання — роздача ставить позначку «у кого», у CRM переводить торкання",
  "base.count": "{n} компаній",
  "base.distribute": "Роздати {n}",
  "base.distributed": "Роздано: {n}. Картки поїхали в CRM і черги селзів.",
  "base.emptyTitle": "База порожня",
  "base.emptyBody": "Усю сировину роздано або видобуток ще не запускався. Запустіть пошук — нові компанії з'являться тут.",
  "base.goMine": "Запустити видобуток",
  "base.col.company": "Компанія",
  "base.col.where": "Ніша · адреса",
  "base.col.score": "Скор",
  "base.col.added": "Додано",
  "crm.board.footnote": "Перетягніть картку між колонками — етап зміниться одразу. Результати дзвінків і відповіді пошти рухають картки самі.",
  "base.autoAll": "Розподілити все порівну",
  "base.autoAllHint": "Уся сировина роздається селзам змійкою за скором — порівну за кількістю та якістю",
  "base.autoToggle": "авто при заході",
  "base.autoToggleHint": "Увімкнено — База сама роздає сировину при кожному заході керівника",
  "base.autoRan": "Авто: роздано {n} — {split}",
  "base.distributedSplit": "Роздано {n}: {split}",
  "base.fairSelected": "Порівну {n}",
  "base.fairHint": "Вибрані роздаються між селзами змійкою за скором",
  "base.orExact": "або точково:",
  "base.pickRep": "кому…",
  "base.giveExact": "Віддати",
  "base.funnelOpt": "Воронка (необов'язково)",
  "base.funnelOptHint": "З воронкою лід входить у шлях торкань; без — просто стає в чергу селза",
  ...
  "calls.state.missed": "Не додзвонились",
  "calls.state.processing": "Запис обробляється: розшифровка й розбір з'являться за хвилину",
  "calls.state.failed": "Запис не вдалося обробити",
  "calls.nextStep": "Наступний крок",
  "calls.suggested": "ШІ пропонує результат",
  "calls.quality": "якість {n}/10",
  "calls.showTranscript": "Показати розшифровку",
  "calls.hideTranscript": "Сховати розшифровку",
  "calls.speakerRep": "Менеджер",
  "calls.speakerClient": "Клієнт",
  "calls.outcome.goal": "Ціль",
  "calls.outcome.callback": "Передзвон",
  "calls.outcome.thinking": "Думає",
  "calls.outcome.no_answer": "Недодзвон",
  "calls.outcome.refused": "Відмова",
  "calls.outcome.wrong_number": "Невірний номер",
  "tel.noTeam": "Телефонія налаштовується для команди — виберіть командний простір.",
  "tel.saved": "Номер збережено",
  "tel.phonePh": "+380… або SIP-логін",
  "tel.statusTitle": "ПІДКЛЮЧЕННЯ",
  "tel.providerOn": "Дзвінки через {provider} увімкнено",
  "tel.providerOff": "Провайдер дзвінків не підключено — кнопка «Подзвонити» відкриває телефон на пристрої",
  "tel.sttOn": "Розшифровка й розбір дзвінків увімкнено",
  "tel.sttOff": "Розшифровку вимкнено — дзвінки пишуться без тексту",
  "tel.howToEnable": "Щоб увімкнути: у Railway задайте TELEPHONY_PROVIDER=ringostat, RINGOSTAT_AUTH_KEY, TELEPHONY_WEBHOOK_TOKEN і ELEVENLABS_API_KEY.",
  "tel.myPhoneTitle": "МІЙ НОМЕР ДЛЯ ДЗВІНКІВ",
  "tel.myPhoneHint": "На цей номер система дзвонить вам першою, а після відповіді з'єднує з клієнтом. Номер або SIP-логін з проєкту Ringostat.",
  "tel.me": "Я",
  "tel.teamPhonesTitle": "НОМЕРИ КОМАНДИ",
  "tel.webhookTitle": "WEBHOOK ДЛЯ RINGOSTAT",
  "tel.webhookHint": "У кабінеті Ringostat → Інтеграції → Webhooks створіть webhook на подію «Вихідний дзвінок» з цією адресою. Так платформа дізнається тривалість і отримує запис.",
  ...
  "work.consentSay": "Скажіть на початку:",
  "work.consentUa": "Розмова може записуватися для контролю якості",
  "work.consentEn": "This call may be recorded for quality purposes",
  "work.recOff": "Скасувати запис",
  "work.recOn": "Увімкнути запис",
  "work.recOffNote": "Запис скасовано: розмова не збережеться на платформі.",
  "work.recOffToast": "Запис скасовано",
  "work.recOnToast": "Запис увімкнено",
  "lead.dm.email": "пошта",
  "lead.dm.phone": "телефон",
  "lead.dm.others": "Ще люди в компанії",
} as const;
