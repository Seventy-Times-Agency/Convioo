export const en = {
  ...
  "connectors.subtitle": "Connect your CRM, inbox, and data tools.",
  ...
  "connectors.cat.export": "Export & sync",
  ...
  "lead.extras.activity.repliedKind": "Replied: {summary}",
  "lead.extras.activity.repliedKindBare": "Replied to email",
  "lead.extras.activity.suggestedReply": "Suggested reply:",
  "lead.extras.activity.replyCategory.interested": "Interested",
  "lead.extras.activity.replyCategory.meeting_request": "Meeting",
  "lead.extras.activity.replyCategory.question": "Question",
  "lead.extras.activity.replyCategory.objection": "Objection",
  "lead.extras.activity.replyCategory.not_interested": "Not interested",
  "lead.extras.activity.replyCategory.unsubscribe": "Unsubscribe",
  "lead.extras.activity.replyCategory.auto_reply": "Auto-reply",
  "lead.extras.activity.replyCategory.referral": "Referral",
  "lead.extras.activity.replyCategory.other": "Reply",
  ...
  "search.form.title": "Who are we looking for?",
  "search.form.subtitle": "Describe the niche and region — the system collects and scores the base.",
  ...
  "crm.bulk.assignTo": "Distribute",
  "crm.bulk.assignNoRep": "Rep: keep",
  ...
  "work.tabAnalysis": "Full analysis",
  "work.tabReviews": "Reviews",
  "work.tabSite": "Site & socials",
  ...
  "work.cntDials": "Dials",
  "work.cntTalks": "Conversations",
  "work.cntGoals": "Goals",
  "work.factReviews": "Reviews",
  "work.factSite": "Website",
  "work.factSocial": "Social",
  "work.factLang": "Language",
  "work.scriptEmpty": "No script uploaded yet",
  "work.objectionsTitle": "Objections",
  "common.yes": "yes",
  "common.no": "no",
  "work.notePh": "what was said, what was agreed…",
  "work.callButton": "Call",
  "work.recNote": "Click dials the number (tel:). Call recording lands with the telephony stage.",
  "work.finishCall": "End the call",
  "work.duringHint": "Call in progress — outcomes activate when it ends.",
  "work.oNoAnswer": "No answer",
  "work.oWrongNumber": "Wrong number",
  "work.oRefused": "Refused",
  "work.oThinking": "Thinking",
  "work.oCallback": "Call back…",
  "work.oGoalFallback": "Goal reached",
  "work.cbWhen": "When to call back:",
  "work.cb2h": "in 2 hours",
  "work.cbTomorrow": "tomorrow",
  "work.cb3d": "in 3 days",
  "work.goalToast": "Goal reached: {goal}",
  "work.footnote":
    "The goal action comes from the lead's funnel · no answer ×{n} → pause {d} days → free pool",
  ...
  "crm.table.niche": "Niche",
  "crm.table.geo": "Geo",
  "crm.table.lang": "Language",
  "crm.table.assignee": "Assigned",
  "crm.table.free": "free",
  "crm.counts.total": "Total",
  "crm.counts.free": "free",
  "crm.counts.inWork": "in work",
  "crm.counts.archived": "archived",
  ...
  "settings.notion.syncButton": "Sync from Notion",
  "settings.notion.syncHint": "Pull status changes from Notion back into Convioo.",
  "settings.notion.syncResult": "Sync complete: {updated} updated, {errors} errors.",
  "settings.notion.syncFailed": "Sync failed: {detail}",
  ...
  "team.member.confirmRemove": "Remove this member from the team? If they have assigned leads, you'll be asked to hand them over first.",
  "team.member.transferPrompt": "This member has assigned leads. Hand them over to:",
  "team.member.transferPick": "Choose a member…",
  "team.member.transferAndRemove": "Transfer & remove",
  ...
  "team.calls.funnel": "Department funnel · {days} days",
  "team.calls.dials": "Dials",
  "team.calls.connects": "Connects",
  "team.calls.goals": "Goals",
  "team.calls.goalRate": "{p}% of connects",
  "team.calls.byDay": "Dials by day",
  "team.calls.byRep": "By rep · {days} days",
  "team.calls.rep": "Rep",
  "team.calls.conversion": "Conversion",
  ...
  "search.form.leadCountHint": "One lead — one token; fewer leads finish faster",
  "search.form.leadCountHelp": "One base lead costs one token. Where to look is a choice in advanced search.",
  "search.form.sources": "Data sources",
  "search.form.sourcesHint": "Uncheck a source if it's acting up today",
  "search.form.advancedShow": "Advanced search",
  "search.form.advancedHide": "Hide advanced search",
  "search.form.channels": "Where to look",
  "search.form.channelsHint": "Search channels — leaving all on is fine",
  "search.form.dm": "Decision-maker contact",
  "search.form.dmHint": "Costs more, not always found",
  "search.form.dmHelp": "Look up the name and contact of whoever decides. These are extra calls to paid sources, and for some companies nothing is found at all. Turn it off if you only need the company list.",
  ...
  // ---- Wave 4: white-label reports ----
  "settings.tab.branding": "Branding",
  "settings.branding.eyebrow": "Branding",
  "settings.branding.help":
    "Your agency name, logo and accent colour appear on every client report you share.",
  "settings.branding.noTeam":
    "Branding is set per team. Switch to a team workspace to edit it.",
  "settings.branding.error": "Couldn't load branding.",
  "settings.branding.forbidden": "Only the team owner can edit branding.",
  "settings.branding.name.label": "Agency name",
  "settings.branding.name.placeholder": "Your agency",
  "settings.branding.color.label": "Accent color",
  "settings.branding.color.errorFormat": "Use a hex color like #6366F1.",
  "settings.branding.logo.label": "Logo",
  "settings.branding.logo.hint": "PNG, JPG or WebP, up to 200 KB.",
  "settings.branding.logo.remove": "Remove",
  "settings.branding.logo.previewAlt": "Logo preview",
  "settings.branding.logo.errorType": "Please choose an image file.",
  "settings.branding.logo.errorSize":
    "That image is over 200 KB. Pick a smaller file.",
  "settings.branding.logo.errorRead": "Couldn't read that file.",

  "shareReport.button": "Share report",
  "shareReport.title": "Share report",
  "shareReport.subtitle":
    "Create a public link to a branded report for this search.",
  "shareReport.titleField": "Title (optional)",
  "shareReport.titlePlaceholder": "Report title",
  "shareReport.expiry": "Link expiry",
  "shareReport.expiry.never": "Never expires",
  "shareReport.expiry.7": "7 days",
  "shareReport.expiry.30": "30 days",
  "shareReport.create": "Create link",
  "shareReport.ready":
    "Your report link is ready. Share it with your client.",
  "shareReport.linkLabel": "Share link",
  "shareReport.downloadPdf": "Download PDF",
  "shareReport.expiresOn": "Expires on {date}",

  "report.defaultTitle": "Lead report",
  "report.downloadPdf": "Download PDF",
  "report.insights": "Insights",
  "report.topLeads": "Top leads",
  "report.topLeads.empty": "No leads to show.",
  "report.stat.total": "Total leads",
  "report.stat.hot": "Hot leads",
  "report.stat.withEmail": "With email",
  "report.stat.replied": "Replied",
  "report.stat.avgScore": "Avg score",
  "report.col.name": "Name",
  "report.col.score": "Score",
  "report.col.status": "Status",
  "report.col.contact": "Contact",
  "report.col.unnamed": "Unnamed",
  "report.generatedOn": "Generated on {date}",
  "report.footer": "Generated with Convioo",
  "report.gone.title": "This report link is no longer available",
  "report.gone.body":
  ...
  "lp.nav.integrations": "Integrations",
  "lp.nav.developers": "Developers",
  "lp.hero.badge": "now classifies replies automatically",
  "lp.hero.title1": "Describe it.",
  "lp.hero.title2": "It's done.",
  "lp.hero.subtitle": "One plain-language sentence becomes a scored, enriched, outreach-ready pipeline. Four data sources, one AI analyst, about 90 seconds.",
  "lp.hero.prompt": "roofing companies in New York",
  "lp.hero.find": "Find leads",
  "lp.hero.startFree": "Start free",
  "lp.hero.watch": "Watch demo",
  "lp.hero.noCard": "No credit card",
  "lp.hero.sources": "Sources:",
  "lp.hero.orb": "scoring your leads in real time",
  "lp.metric.leads": "leads enriched",
  "lp.metric.rating": "average rating",
  "lp.metric.integrations": "native integrations",
  "lp.how.eyebrow": "How it works",
  "lp.how.title": "Sentence in, pipeline out",
  "lp.step.describe.t": "Describe",
  "lp.step.describe.d": "Type who you want in plain language — niche, region, any constraint.",
  "lp.step.collect.t": "Collect",
  "lp.step.collect.d": "Google Places, Yelp, OpenStreetMap and Foursquare — deduplicated, sites scraped for contacts and signals.",
  ...
  "lp.feat.search.d": "One query, four data sources — deduplicated, then enriched with contacts scraped from each company's website.",
  "lp.feat.henry.t": "Henry AI copilot",
  "lp.feat.henry.d": "Scores every lead, explains why, drafts outreach and answers questions about your pipeline.",
  ...
  "lp.henry.title": "An analyst on the team, not a chatbot in the corner",
  "lp.henry.body": "Henry reads every lead's website, reviews and signals, then scores it against your service. Ask for leads, drafts, or a read on your pipeline — he answers with work done.",
  "lp.henry.p1": "Personalized scoring against your service, not a generic grade",
  "lp.henry.p2": "Drafts intros in your tone — ready to send or edit",
  "lp.henry.p3": "Classifies replies: interested / later / not a fit — with suggested answers",
  "lp.henry.chatUser": "Find 20 dentists in Austin with weak websites and draft an intro email",
  "lp.henry.chatBot": "Done — 20 dentists found. 7 have weak websites (no SSL, failing mobile checks, or 5+ years stale). Drafts attached:",
  "lp.henry.lead1": "No SSL · site last updated 2019",
  "lp.henry.lead2": "Fails mobile speed check",
  "lp.henry.lead3": "No online booking form",
  "lp.henry.draft": "Draft",
  "lp.int.eyebrow": "Integrations",
  "lp.int.title": "Plugged into your stack",
  "lp.int.body": "Native connectors plus a public API and webhooks for everything else.",
  "lp.int.connect": "Connect",
  "lp.int.g.email": "Email",
  "lp.int.g.crm": "CRM",
  "lp.int.g.workspace": "Workspace",
  "lp.int.g.alerts": "Alerts",
  "lp.int.g.automation": "Automation",
  "lp.pricing.eyebrow": "Pricing",
  "lp.pricing.title": "Start free, scale as you grow",
  "lp.pricing.monthly": "Monthly",
  "lp.pricing.annual": "Annual −20%",
  "lp.pricing.popular": "Most popular",
  "lp.pricing.perMonth": "month",
  "lp.tier.starter.name": "Starter",
  "lp.tier.starter.for": "For solo freelancers",
  "lp.tier.starter.cta": "Start free",
  "lp.tier.starter.f1": "300 leads / month",
  "lp.tier.starter.f2": "1 seat",
  "lp.tier.starter.f3": "AI scoring by Henry",
  "lp.tier.starter.f4": "CSV & Excel export",
  "lp.tier.starter.f5": "Email support",
  "lp.tier.growth.name": "Growth",
  "lp.tier.growth.for": "For small agencies",
  "lp.tier.growth.cta": "Start free trial",
  "lp.tier.growth.f1": "2,000 leads / month",
  "lp.tier.growth.f2": "5 seats",
  "lp.tier.growth.f3": "Sequences + AI reply handling",
  "lp.tier.growth.f4": "All integrations",
  "lp.tier.growth.f5": "Priority support",
  "lp.tier.agency.name": "Agency",
  "lp.tier.agency.for": "For teams at scale",
  "lp.tier.agency.cta": "Talk to sales",
  "lp.tier.agency.f1": "10,000 leads / month",
  "lp.tier.agency.f2": "Unlimited seats",
  "lp.tier.agency.f3": "API & webhooks",
  "lp.tier.agency.f4": "White-label reports",
  "lp.tier.agency.f5": "Dedicated manager",
  "lp.quote1": "Convioo replaced three tools for us. I type a sentence on Monday morning and the pipeline is full by lunch.",
  "lp.quote2": "Henry's scoring is scary good. Our reply rate doubled because we only contact leads worth contacting.",
  "lp.quote3": "We onboarded the whole team in one afternoon. It just feels finished — rare for tools in this space.",
  "lp.trust.gdpr.t": "GDPR-ready",
  "lp.trust.gdpr.d": "Data processing agreements and EU data residency on request.",
  "lp.trust.unsub.t": "One-click unsubscribe",
  "lp.trust.unsub.d": "Every sequence ships with compliant opt-out handling built in.",
  "lp.trust.own.t": "You own your data",
  "lp.trust.own.d": "Export or delete everything — leads, notes, timelines — any time.",
  "lp.trust.region.t": "EU · UK · US",
  "lp.trust.region.d": "Built for agencies on both sides of the Atlantic.",
  "lp.faq.eyebrow": "FAQ",
  "lp.faq.title": "Frequently asked questions",
  "lp.faq.sources.q": "Where do the leads come from?",
  "lp.faq.sources.a": "Google Places, OpenStreetMap, Yelp and Foursquare. We deduplicate and enrich them with contacts scraped from company websites.",
  "lp.faq.how.q": "How accurate is Henry's scoring?",
  "lp.faq.how.a": "Henry scores every lead against your service and explains why, so you only reach out to the ones worth contacting.",
  "lp.faq.credits.q": "How are leads counted?",
  "lp.faq.credits.a": "Each plan includes a monthly lead allowance. Unused leads don't roll over; you can raise the limit any time.",
  "lp.faq.cancel.q": "Can I cancel any time?",
  "lp.faq.cancel.a": "Yes. No contracts — manage your subscription from settings and cancel in one click.",
  "lp.cta.title1": "Turn a sentence into",
  "lp.cta.title2": "a sales pipeline.",
  "lp.cta.sub": "No credit card · 50 free leads · Cancel anytime",
  "lp.foot.product": "Product",
  "lp.foot.company": "Company",
  "lp.foot.legal": "Legal",
  "lp.foot.about": "About",
  "lp.foot.contact": "Contact",
  "lp.foot.apidocs": "API docs",
  "lp.foot.status": "Status",
  "lp.foot.privacy": "Privacy",
  "lp.foot.terms": "Terms",
  "lp.foot.cookies": "Cookies",
  "lp.foot.tagline": "The AI-native lead-gen platform for marketing agencies.",
  "lp.foot.rights": "All rights reserved.",

  // Funnels (wave 1)
  "funnels.validation": "Fill in the funnel name and the goal action",
  "funnels.confirmDelete":
    "Delete this funnel? Leads stay in the base but detach from the touch path.",
  "funnels.noTeamTitle": "Funnels live in a team",
  "funnels.noTeamHint":
    "Switch to a team workspace to configure the department's funnels.",
  "funnels.listTitle": "Team funnels",
  "funnels.emptyTeaches":
    "A funnel defines the touch path, the script, the templates and the rep's green button. Create the first one — the product starts empty.",
  "funnels.cardMeta": "{n} leads · goal: {goal}",
  "funnels.new": "New funnel",
  "funnels.footnote":
    "A funnel defines the touch path, script, templates and the rep's green button",
  "funnels.pickTitle": "Pick a funnel",
  "funnels.pickHint":
    "The team's funnels are on the left. Pick one to configure or create a new one.",
  "funnels.newTitle": "New funnel",
  "funnels.duplicate": "Duplicate",
  "funnels.goalSection": "Goal action — the rep's green button",
  "funnels.name": "Funnel name",
  "funnels.status": "Status",
  "funnels.statusDraft": "draft",
  "funnels.statusActive": "active",
  "funnels.statusArchived": "archived",
  "funnels.goalName": "Goal name — any text, yours",
  "funnels.goalNameHint": "Free text: audit, demo, meeting, sale…",
  "funnels.goalPh": "Paid audit",
  "funnels.goalPrice": "Price (optional)",
  "funnels.goalAction": "On reaching the goal",
  "funnels.actionPaymentCalendar": "Payment + calendar",
  "funnels.actionInvoice": "Invoice",
  "funnels.actionBooking": "Booking",
  "funnels.actionNone": "Nothing",
  "funnels.pathSection": "Touch path",
  "funnels.noAnswerRule": "no answer ×{n} → pause {d} days → free pool",
  "funnels.stepCall": "Call",
  "funnels.stepEmail": "Email",
  "funnels.days": "d.",
  "funnels.stepAuto": "auto",
  "funnels.stepNotePh": "note: script, template…",
  "funnels.addStep": "Add a touch",
  "funnels.attempts": "Call attempts",
  "funnels.pauseDays": "Pause after no-answers, days",
  ...
  "inbox.cat.all": "All",
  "inbox.cat.interested": "Interested",
  "inbox.cat.meeting": "Meeting",
  "inbox.cat.question": "Question",
  "inbox.cat.objection": "Objection",
  "inbox.cat.notInterested": "Not interested",
  "inbox.cat.unsubscribe": "Unsubscribe",
  "inbox.cat.autoReply": "Auto-reply",
  "inbox.cat.referral": "Referral",
  "inbox.cat.other": "Other",
  "inbox.aiHint": "incoming replies are classified automatically",
  "inbox.draftReady": "draft ready",
  "inbox.aiVerdict": "AI verdict",
  "inbox.draftTitle": "Draft reply · from AI",
  "inbox.copyDraft": "Copy draft",
  "inbox.sendHint": "Sending appears once a mailbox is connected.",
  "inbox.noDraft": "No draft is prepared for this category.",
  "letters.tabCalls": "Calls",
  "letters.tabLetters": "Letters",
  "letters.quota": "Send limit today: {sent} / {cap} · domain warmup, day {day}",
  "letters.pending": "Awaiting approval · {n}",
  "letters.scheduled": "Going out automatically · {n}",
  "letters.touch": "touch {i} of {n}",
  "letters.pendingEmpty": "Nothing is awaiting approval.",
  "letters.scheduledEmpty": "No automatic letters for today.",
  "letters.suppressionNote": "Unsubscribes and do-not-contact are honoured automatically.",
  "letters.workerNote": "Automatic letters are sent by the background worker — without it the queue stands still.",
  "st.tab.company": "Company",
  "st.tab.integrations": "Integrations",
  "st.tab.telephony": "Telephony",
  "st.tab.mail": "Email",
  ...
  "intg.st.notConnected": "not connected",
  "intg.st.soon": "soon",
  "intg.configure": "Configure",
  "intg.connect": "Connect",
  "intg.unavailable": "Unavailable",
  "intg.telegram.title": "Telegram bot",
  ...
  "intg.calendar.desc": "Audit and meeting slots. The booking link goes to the client when a funnel goal is reached.",
  "intg.hubspot.title": "HubSpot",
  "intg.hubspot.desc": "Push deals into your CRM. Push works today; two-way sync is planned.",
  "intg.pipedrive.title": "Pipedrive",
  "intg.pipedrive.desc": "Push deals into Pipedrive.",
  "intg.notion.title": "Notion",
  "intg.notion.desc": "Two-way sync of the lead base with Notion.",
  "intg.slack.title": "Slack",
  "intg.slack.desc": "New-lead and reply alerts in your channel.",
  "intg.sheets.title": "Google Sheets",
  "intg.sheets.desc": "Export search results straight into a spreadsheet.",
  "intg.agencyos.title": "Agency OS",
  "intg.agencyos.desc": "Link to the delivery platform: funnel goal → client card in production.",
  "intg.webhooks.title": "Webhooks & API",
  "intg.webhooks.desc": "Your own automations: signed lead events sent to your URL.",
  "intg.marketplaceBtn": "Connector marketplace",
  "intg.footer": "Integration keys are stored encrypted; only the admin and owner can access them. Billing and plans are the owner's section.",
  "tel.soonTitle": "Telephony will live here",
  "tel.soonBody": "Number provisioning, call recording with transcripts and per-region recording rules. For now calls go through click-to-call from your phone, and outcomes are logged in Work mode.",
  "jr.immutable": "The log is immutable: entries can't be edited or deleted — even by the owner",
  "jr.who": "Who",
  "jr.kindF": "Type",
  "jr.period": "Period",
  "jr.all": "all",
  "jr.allKinds": "all actions",
  "jr.days7": "7 days",
  "jr.days30": "30 days",
  "jr.days90": "90 days",
  "jr.col.when": "WHEN",
  "jr.col.who": "WHO",
  "jr.col.action": "ACTION",
  "jr.col.object": "OBJECT",
  "jr.system": "System",
  "jr.today": "today",
  "jr.yesterday": "yesterday",
  "jr.empty": "No entries for the selected period.",
  "jr.noTeam": "The action log lives in the team workspace.",
  "jr.denied": "The action log is available to the owner and admin.",
  "jr.k.batch_assigned": "Batch distributed: {count} leads → {assignee}",
  "jr.k.batch_assigned_pool": "Batch distributed: {count} leads into the funnel",
  "jr.o.batch": "Base · {funnel} funnel",
  "jr.k.funnel_created": "New funnel: “{name}”",
  "jr.k.funnel_updated": "Funnel changed: “{name}”",
  "jr.k.funnel_deleted": "Funnel deleted: “{name}”",
  "jr.o.funnels": "Funnels",
  "jr.k.member_invited": "Team invite sent: {role} (pending)",
  "jr.o.team": "Team",
  "jr.k.role_changed": "Role changed: {member} — {from} → {to}",
  "jr.k.member_removed": "Removed from the team: {member}",
  "jr.k.member_left": "Left the team: {member}",
  "jr.k.transferredLeads": "{count} leads handed over",
  "jr.k.ownership_transferred": "Ownership transferred: {to}",
  "jr.k.cost_cap_changed": "Cost ceiling changed: {from} → {to}",
  "jr.o.settings": "Settings",
  "jr.k.search_finished": "Search finished: {leads} leads · {tokens} tokens",
  "jr.o.search": "Search · {region}",
  "jr.k.leads_exported": "Base exported (CSV)",
  "jr.o.base": "Base",
  "jr.noCap": "no ceiling",
  "bl.offNotice": "Internal instance: billing is off. This screen is the SaaS mode — enabled by a setting at market launch.",
  "bl.ownerOnly": "Billing and plans are the owner's section.",
  "bl.perMonth": "/mo",
  "bl.current": "current",
  "bl.plan.solo.desc": "1 user · 500 tokens per month · 1 funnel · calls and emails",
  "bl.plan.team.desc": "up to 8 seats · 3,000 tokens per month · unlimited funnels · public registries",
  "bl.plan.agency.desc": "up to 25 seats · 12,000 tokens per month · white-label reports · API · priority support",
  "bl.tokenHint": "1 base lead = 1 token · decision-maker search costs more · top-ups available on any plan",
  "bl.invoices": "INVOICES",
  "bl.invoicesEmpty": "No invoices yet — billing is not enabled.",
  "bl.usage": "USAGE · 30 DAYS",
  "bl.tokens": "Tokens",
  "bl.balance": "balance",
  "bl.spentMonth": "spent in 30 days: {n}",
  "bl.leads": "Leads with full dossier",
  "bl.leadsHint": "one lead — one token",
  "bl.emails": "Emails",
  "bl.emailsHint": "warmup raises the cap on its own",
  "bl.spend": "Search spend",
  "bl.spendHint": "the ceiling is set by the owner on the Integrations tab",
  "bl.topup": "Buy tokens",
  "bl.changePlan": "Change plan",
  "bl.soon": "soon",
  "bl.noTeam": "Plans and tokens live in the team workspace.",
  "hp.heading": "How can we help?",
  "hp.searchPh": "Search the knowledge base: “how to set a callback”, “what does scoring mean”…",
  "hp.cat1.t": "Getting started",
  "hp.cat1.b": "Your first day: the queue, the card, outcomes — in 10 minutes",
  "hp.cat2.t": "Calling",
  "hp.cat2.b": "Callbacks, recording, outcomes and what each button does",
  "hp.cat3.t": "Emails & inbox",
  "hp.cat3.b": "AI drafts, sending caps, reply triage",
  "hp.faq": "FREQUENT QUESTIONS",
  "hp.q1": "Why did a lead disappear from my queue?",
  "hp.a1": "The funnel's no-answer rule fired: after several failed attempts the lead moves to the free pool so your queue stays clean. A manager can hand it back from the Base.",
  "hp.q2": "What does “hot” mean and where does scoring come from?",
  "hp.a2": "AI computes a 0–100 score from the company dossier: website, reviews, growth signals. “Hot” means an interested reply or a high score. It's a priority hint, not a verdict.",
  "hp.q3": "How do I move a callback to another time?",
  "hp.a3": "In the lead card pick the “Call back” outcome and a time. The lead returns to your queue exactly then, at the top.",
  "hp.q4": "The client asks not to be called — what do I press?",
  "hp.a4": "The “Do not disturb” outcome. The number and email go on the suppression list: the system won't call or email again, even from another funnel.",
  "hp.ai.t": "Can't find an answer — ask the AI assistant",
  "hp.ai.b": "Knows the team knowledge base and helps on any screen",
  "hp.ai.btn": "Ask AI",
  "hp.soon": "soon",
  "hp.noResults": "Nothing matched your search. Ask your team lead — or write to us.",
  "search.form.henryBtn": "Pick with Henry",
  ...
  "dob.history": "RUN HISTORY",
  "dob.allSessions": "all sessions ▸",
  "dob.historyEmpty": "No runs yet. Your first search will appear here.",
  "dob.failed": "failed",
  ...
  "squads.title": "COMPANY SQUADS",
  "squads.hint": "A team lead sees their squad and the free pool; the summary rolls up",
  "squads.empty": "No squads yet — the whole company works as one pool. Create a squad, pick a team lead and add people.",
  "squads.membersCount": "{n} people",
  "squads.noLead": "no team lead",
  "squads.leadPrefix": "lead:",
  "squads.toPool": "To the free pool",
  "squads.addMember": "+ add member",
  "squads.namePh": "Squad name",
  "squads.create": "Create squad",
  "squads.created": "Squad created",
  "squads.deleteConfirm": "Disband “{name}”? People go to the free pool; their leads stay with them.",
  "jr.k.squad_created": "New squad: “{name}”",
  "jr.k.squad_updated": "Squad changed: “{name}”",
  "jr.k.squad_deleted": "Squad disbanded: “{name}”",
  "jr.k.squad_member_moved": "Moved to squad: {member} → {squad}",
  ...
  "desk.myCalls": "My calls",
  "desk.backToDesk": "Team desk",
  "desk.dials": "DIALS",
  "desk.talks": "TALKS",
  "desk.goals": "GOALS",
  "desk.col.rep": "REP",
  "desk.col.squad": "SQUAD",
  "desk.col.dials": "DIALS",
  "desk.col.talks": "TALKS",
  "desk.col.goals": "GOALS",
  "desk.col.overdue": "OVERDUE",
  "desk.col.state": "STATE",
  "desk.live": "on calls",
  "desk.idle": "no calls today",
  "desk.quietSince": "quiet since {time}",
  "desk.overdueN": "{n} callbacks",
  ...
  "base.subtitle": "raw until the first touch — distribution marks the owner, a touch moves it to the CRM",
  "base.count": "{n} companies",
  "base.distribute": "Distribute {n}",
  "base.distributed": "Distributed: {n}. Cards moved to the CRM and rep queues.",
  "base.emptyTitle": "The base is empty",
  "base.emptyBody": "Everything is distributed or no mining has run yet. Launch a search and new companies land here.",
  "base.goMine": "Launch mining",
  "base.col.company": "Company",
  "base.col.where": "Niche · address",
  "base.col.score": "Score",
  "base.col.added": "Added",
  "crm.board.footnote": "Drag a card between columns to change its stage. Call outcomes and email replies move cards on their own.",
  "base.autoAll": "Distribute all fairly",
  "base.autoAllHint": "All raw leads split among reps snake-wise by score — fair by count and quality",
  "base.autoToggle": "auto on entry",
  "base.autoToggleHint": "When on, the Base distributes raw leads on every manager visit",
  "base.autoRan": "Auto: {n} distributed — {split}",
  "base.distributedSplit": "Distributed {n}: {split}",
  "base.fairSelected": "Fairly split {n}",
  "base.fairHint": "Selected leads split among reps snake-wise by score",
  "base.orExact": "or exactly:",
  "base.pickRep": "to whom…",
  "base.giveExact": "Give",
  "base.funnelOpt": "Funnel (optional)",
  "base.funnelOptHint": "With a funnel the lead enters the touch path; without it it just joins the rep's queue",
  ...
  "calls.state.missed": "No answer",
  "calls.state.processing": "Processing the recording: transcript and analysis in a minute",
  "calls.state.failed": "Could not process the recording",
  "calls.nextStep": "Next step",
  "calls.suggested": "AI suggests",
  "calls.quality": "quality {n}/10",
  "calls.showTranscript": "Show transcript",
  "calls.hideTranscript": "Hide transcript",
  "calls.speakerRep": "Rep",
  "calls.speakerClient": "Client",
  "calls.outcome.goal": "Goal",
  "calls.outcome.callback": "Callback",
  "calls.outcome.thinking": "Thinking",
  "calls.outcome.no_answer": "No answer",
  "calls.outcome.refused": "Refused",
  "calls.outcome.wrong_number": "Wrong number",
  "tel.noTeam": "Telephony is set up per team — pick a team workspace.",
  "tel.saved": "Number saved",
  "tel.phonePh": "+380… or SIP login",
  "tel.statusTitle": "CONNECTION",
  "tel.providerOn": "Calls via {provider} are on",
  "tel.providerOff": "No call provider — the Call button opens your device dialer",
  "tel.sttOn": "Call transcription and analysis are on",
  "tel.sttOff": "Transcription is off — calls are recorded without text",
  "tel.howToEnable": "To enable: set TELEPHONY_PROVIDER=ringostat, RINGOSTAT_AUTH_KEY, TELEPHONY_WEBHOOK_TOKEN and ELEVENLABS_API_KEY in Railway.",
  "tel.myPhoneTitle": "MY CALLING NUMBER",
  "tel.myPhoneHint": "The system rings this number first, then connects the client. A number or SIP login from your Ringostat project.",
  "tel.me": "Me",
  "tel.teamPhonesTitle": "TEAM NUMBERS",
  "tel.webhookTitle": "RINGOSTAT WEBHOOK",
  "tel.webhookHint": "In Ringostat → Integrations → Webhooks create an Outbound call webhook with this URL so the platform gets the duration and recording.",
  ...
  "work.recOff": "Stop recording",
  "work.recOn": "Resume recording",
  "work.recOffNote": "Recording cancelled: the call won't be kept on the platform.",
  "work.recOffToast": "Recording cancelled",
  "work.recOnToast": "Recording on",
  "lead.dm.email": "email",
  "lead.dm.phone": "phone",
  "lead.dm.others": "Other people",
} as const;
